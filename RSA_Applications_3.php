 ...
 aria-label="Course Navigation"> <?php include 'about_RSA_Services_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <div class="pagination">
                ...
                <a href="#" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('RSA_Applications_3.php', this)" class="page-link active">3</a>
              </div>
            </section>
