...
<section class="col-md-9 col-lg-9">
              <h3>Price</h3>
              <br />
              <p id="p-style">Geophysical products are subjected to download as per the policy, terms and conditions and disclaimers mentioned in Links in Bhuvan portal. Some products are freely downloadable whereas certain thematic layers are accessible through OGC web services. </p>
            </section>
          </div>
        </div>
      </section>
