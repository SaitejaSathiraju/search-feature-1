<div class="services-list">
    ...
    <a href="./Apps_DMS_overview.php" >Overview</a>
    <a href="./Apps_DMS.php" >Applications</a>
    <a href="./Apps_DMS_sensors.php" >Sensors</a>
    <a href="./Apps_DMS_users.php" >Users</a>
    <a href="./Apps_DMS_portals.php" >Portals</a>
</div>
