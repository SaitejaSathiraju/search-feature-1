...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'about_ASDM_Services_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <br />
              <center>
                <img data-entity-type="file" src="assets/img/about/Aircrafts_0.jpg" />
              </center>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/img1_1.jpg" />
                    <div class="image-overlay">NRSC Building at Airport</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/img2_2.jpg" />
                    <div class="image-overlay">Aircraft B200</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/img3_2.jpg" />
