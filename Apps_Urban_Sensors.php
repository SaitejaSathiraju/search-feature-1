...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Urban_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Resourcesat LISS IV is used for urban land use characterization and planning.
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>High resolution satellite of 1m or better are used for Town Planning activities .
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>LISS II / LISS IV data is used for estimation changes in urban sprawl.
                </li>
              </ul>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/pipeline.png" />
                    <div class="image-overlay">Pipeline Monitoring</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/Picture1_0.jpg" />
