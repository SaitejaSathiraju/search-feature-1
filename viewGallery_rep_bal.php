...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>Republic Day Celebrations @ NRSC, Balanagar, 26th January 2025</b></h3>
    </div>
  </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const imagePath = 'assets/img/event-gallery/republic_day_balanagar/';
