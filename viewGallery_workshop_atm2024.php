...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>Two-day Workshop & Training Programme on 'Atmospheric Lightning monitoring, forecasting and mitigation' during 28-29 Nov 2024 organized by NICES at NRSC, Jeedimetla, Hyderabad</b></h3>
    </div>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const totalImages = 7; // Modify if needed
    const imagePath = 'assets/img/event-gallery/Atmospheric_workshop/';
