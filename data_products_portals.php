        ...
        <nav class="breadcrumbs" aria-label="Breadcrumb">
          <div class="container">
            <ol>
              ...
              <li class="current">
                <b>Data Dissemination Portals</b>
              </li>
            </ol>
          </div>
        </nav>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <a href="https://bhoonidhi.nrsc.gov.in/bhoonidhi/home.html" target="_blank">
                      <img data-entity-type="file" src="assets/img/about/Bhoonidhi_1.jpg" alt="Bhoonidhi"/>
                    </a>
                    <div class="image-overlay">Bhoonidhi</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <a href="https://bhuvan.nrsc.gov.in" target="_blank">
                      <img data-entity-type="file" src="assets/img/about/bhuvanimage.png" alt="BHUVAN"/>
                    </a>
                    <div class="image-overlay">BHUVAN</div>
                  </div>
                  <!-- <div class="image-item" onclick="openLightbox(this)">
                    <a href="https://sagar.nrsc.gov.in/SAGARPortal/ScatSat-debug/ScatSatHome.html" target="_blank">
                      <img data-entity-type="file" src="assets/img/about/sagar_0.png" alt="SAGAR"/>
                    </a>
                    <div class="image-overlay">SAGAR</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <a href="https://www.mosdac.gov.in/" target="_blank">
                      <img data-entity-type="file" src="assets/img/about/mosdac.png" alt="MOSDAC"/>
                    </a>
                    <div class="image-overlay">MOSDAC</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <a href="https://www.issdc.gov.in/" target="_blank">
                      <img data-entity-type="file" src="assets/img/about/issdc.png" alt="ISSDC"/>
                    </a>
