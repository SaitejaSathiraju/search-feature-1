...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>YuViKa-2025 Inauguration 19th May 2025</b></h3>
    </div>
    <div class="container my-3">
      <div class="bg-light rounded shadow-sm p-4 mx-auto" style="max-width: 1200px;">
        <p class="mb-3 text-justify">
          The <strong>"Young Scientist Programme"</strong> or <strong>"YUva VIgyani KAryakram (YUVIKA)"</strong> is an initiative designed to spark curiosity and awareness among school students, especially those from rural areas. The programme offers foundational exposure to <strong>Space Technology, Space Science,</strong> and <strong>Space Applications</strong>.
        </p>

        <p class="mb-3 text-justify">
          Its main objective is to familiarize young minds with emerging scientific and technological trends, nurturing them as the future innovators and leaders of our nation. ISRO has crafted this programme with the intent to <em>"Catch them young"</em>.
        </p>

        <p class="mb-0 text-justify">
          The initiative also aims to inspire students to pursue careers in <strong>STEM (Science, Technology, Engineering, and Mathematics)</strong>. YUVIKA 2025 was conducted as a <strong>2-week residential programme</strong> by <strong>NRSC/ISRO</strong> from <strong>May 19 – 30, 2025</strong>, successfully engaging <strong>48 students from 7 different states</strong>.
        </p>
      </div>
    </div>
  </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const imagePath = 'assets/img/yuvika2025/';
