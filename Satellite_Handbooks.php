...
<html lang="en">
          ...
          <div class="container-fluid">
            <div class="row justify-content-center text-center">
              <div class="col-12 col-sm-10 col-md-9 col-lg-9">
                <h1 class="heading-title text-break text-center">Types of Data Products</h1>
              </div>
            </div>
          </div>
        </section>
 ...
 aria-label="Course Navigation"> <?php include 'satellite_handbooks_services_list.php'; ?> </aside>
...
function setupPagination() {
  ...
  if (pageCount === 0) {
    ...
    li.innerHTML = `<a class="page-link">No results</a>`;
