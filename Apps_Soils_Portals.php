        ...
        <div class="container-fluid">
          <div class="row gy-4">
            ...
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  ...
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php" ; target="_blank">Bhuvan-Erosion
                </li>
                </a>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php" ; target="_blank">Bhuvan-Salt Affected and Water Logging
                </li>
                </a>
              </ul>
            </section>
            <aside class="col-md-3 sidebar">
              <div class="section">
                <h3>SOILS PORTAL IMAGE</h3>
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/ldd map of India.png" />
