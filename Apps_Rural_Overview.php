...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Rural_List.php'; ?> </aside>
            <section class="col-lg-6">
              <h3>Overview</h3>
              <br />
              <p id="myptag">Rural development applications are continuously focussing on water and land conservation through systematic planning, implementation of development plans in rural sector. Applications of geospatial solutions and their implementation in rural development sector provide customized near real time natural resources databases, tools for the analytics and drawing the water and land resources plans.</p>
              <p id="myptag">There are several initiatives / projects, which are taken up by State and Central Government departments at micro and macro level to enrich the assets required in rural sector for the sustainable development through growth of agriculture like Mahatma Gandhi National Rural Employment Guarantee Act (MGNREGA) (collected information on 3.5 crore assets),Accelerated Irrigation Benefit Programme (AIBP), Integrated Watershed Management, Programme (IWMP) (collected information on 1.5 Lakh points), and On Farm Water Management (OFWM), National Health Resource Repository (NHRR) Project, Rural connectivity, which uses the latest remote sensing and GIS technologies in operational modes.</p>
              <p id="myptag">Rural health sanitation improvement programmes are also playing major role in sustainable development. Several projects are being executed for supporting Ministry of Rural Development and are useful for governance. </p>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img style="height: 300px;" data-entity-type="file" src="assets/img/apps/Picture4_8.png" />
                    <div class="image-overlay">GeoMGNREGA</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img style="height: 300px;" data-entity-type="file" src="assets/img/apps/Picture2_8.png" />
                    <div class="image-overlay">Farm Pond</div>
                  </div>
                </div>
              </div>
            </aside>
