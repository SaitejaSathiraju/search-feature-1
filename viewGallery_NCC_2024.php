...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>Geospatial Technologies Training Module for NCC Officers Training Academy (NCC-OTA) Pre-Commissioning Officers at Kamptee, Maharashtra on 28th November 2024</b></h3>
    </div>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const imagePath = 'assets/img/event-gallery/NCC_2024/';
