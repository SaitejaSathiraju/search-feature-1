        ...
        <div class="container-fluid">
          <div class="row gy-4">
            ...
            <section class="col-lg-6">
              <h3>NRSC Begumpet </h3>
              <br>
              <p id="myptag"> Two Aircrafts are housed and operated from the Hanger established at Begumpet Airport. The aerial services and digital mapping activites being carried out for providing services and value-added solutions for various large scale applications like aerial photography and digital mapping, infrastructure planning, scanner surveys, aeromagnetic surveys, large scale base map, topographic and cadastral level mapping, etc. </p>
              <br>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img src="./nrsc_images/about_campuses_begumpet.png" alt="NRSC BEGUMPET">
                  </div>
                </div>
              </div>
            </aside>
