          ...
          <div class="row gy-4">
            ...
            <section class="col-lg-6">
              ...
              <div class="addBox">
                ...
                <p id="addStyle">
                  <b>Director</b>
                  <br> National Remote Sensing Centre, <br> Indian Space Research Organisation, <br> Dept. of Space, Govt. of India, <br> Jeedimetla, Hyderabad - 500015, <br> Near Dulapally Cross Road, <br> Telangana State
                </p>
              </div>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img src="assets/img/campuses/jeedimetla/02.jpg" alt="NRSC JEEDIMETLA">
                  </div> 
                  <div class="image-item" onclick="openLightbox(this)">
                    <img src="assets/img/campuses/jeedimetla/Jeedimetla.JPG" alt="NRSC JEEDIMETLA">
                  </div>                 
                </div>
              </div>
            </aside> 
