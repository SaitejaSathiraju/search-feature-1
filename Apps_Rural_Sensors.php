...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Rural_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>High resolution satellite data such as Cartosat-1, Cartosat-2 are useful for geotagging of assets created for soil and water conservation measures taken up in watersheds as part of IWMP project
                </li>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Sourcesat 1, 2, 2A, LISS4 is extensively utilised for generation of landuse information at 1: 10000 scale.
                </li>
              </ul>
            </section>
            <div class="sidebar">
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img style="height: 400px; " data-entity-type="file" src="assets/img/apps/newfarmponds-s.jpg" />
                    <div class="image-overlay">Monitoring - Watersheds</div>
                  </div>
                </div>
              </div>
            </div>
