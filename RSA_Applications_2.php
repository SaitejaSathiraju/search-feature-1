 ...
 aria-label="Course Navigation"> <?php include 'about_RSA_Services_List.php'; ?> </aside>
            <section class="col-lg-6">
              <div class="section">
                ...
                <p id="p-style">Horticulture Assessment and Management using Geo-informatics (CHAMAN) is a national mission project for Integrated Development of Horticulture (MIDH), Ministry of Agriculture & Cooperation, GOI and State Horticulture Departments. </p>
              ...
              <div class="section">
                ...
                <p id="p-style">Geospatial Technology for Inventory of Coffee Plantations (GeoCUP) project is executed for Coffee Board, Ministry of Commerce & Industry for generation of reliable database on coffee plantation acreage.</p>
                <a class="read-more" data-modal="ageos-modal" id="p-style">Read more</a>
              </div>
              <div class="section">
                <h3>Mapping of High Value Crops</h3>
                <p id="p-style">High value crops are agricultural produce that give rich dividends in economic terms. These crops are good alternative to reduce the possible risks that arise from mono cropping. Menthol mint (MenthaArvensis) is an important essential oil-bearing plant which</p>
                <a class="read-more" data-modal="ageos-modal-1" id="p-style">Read more</a>
              </div>
              <div class="pagination">
                <a href="RSA_Applications.php" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('RSA_Applications.php', this)" class="page-link">1</a>
                <a href="#" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('RSA_Applications_2.php', this)" class="page-link active">2</a>
