...
<main class="main">
  <div class="container">
    <h3 style="text-align:center">
      <br />
      <b>Integrated Control Room for Emergency Response (ICR-ER) Release</b>
    </h3>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const totalImages = 5; // Modify if needed
    const imagePath = 'assets/img/event-gallery/ICERrelease/';
