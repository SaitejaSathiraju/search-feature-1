              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/Picture1_1.png" />
                    <div class="image-overlay">NRSC Aircrafts</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/Picture3_0.png" />
                    <div class="image-overlay">LIDAR DEM</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/about/Picture2_1.png" />
                    <div class="image-overlay">3D Modelling</div>
                  </div>
                </div>
              </div>
            </aside>
