...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Urban_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Ministry of Housing and Urban Poverty Alleviation (MHUPA)
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Gas Authority of India Limited (GAIL)
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>National Capital Region Planning Board (NCRPB)
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>State Town Planning Departments and Urban Local bodies
                </li>
              </ul>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/amirtsar-sm.jpg" />
                    <!--<div class="image-overlay">ABC</div> -->
                  </div>
                </div>
              </div>
            </aside>
