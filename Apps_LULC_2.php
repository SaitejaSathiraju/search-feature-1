...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'App_lulc_services_list.php'; ?> </aside>
            <section class="col-lg-6">
              <div class="section">
                <h3>Landuse / Land cover Mapping at 1:10,000 scale</h3>
                <p id="myptag">Land Use Land Cover (LULC) mapping was carried out at 1: 10000 scale using satellite data of Resourcesat 2 LISS IV sensor which is having 5.8m spatial resolution under SIS-DP project and is hosted on Bhuvan Panchayat portal. This is useful for the drawing the land and water resources development planning at village / panchayat level.</p>
              </div>
              <div class="section">
                <h3>National Wastelands Mapping : 1:50,000 scale</h3>
                <p id="myptag">National wasteland mapping is being done at different time intervals since 1982. Presently, mapping has been completed 5 times since 1982 at NRSC. Waste land mapping was done during 1980-82 (1: 1 million scale- 8 classes), 2000 (1 : 250000 scale – 13 classes), 2003-04 (1:50000 scale-28 classes), 2005-06 (1:50000 scale-28 classes), change mapping during 2008-09, 2015-16.</p>
                <a class="read-more" data-modal="imgeos-modal" id="myptag">Read more</a>
              </div>
              <div class="section">
                <h3>Pilot study Assessment of Desertification Risk</h3>
                <p id="myptag">Development of a comprehensive model for the assessment of desertiﬁcation risk in Jodhpur district of Rajasthan using desertification indicators grouped under categories like soil, climate, vegetation and socioeconomic parameters is done using satellite-derived information layers and other ancillary data. Desertification risk assessment model was developed using step wise multiple regression analysis. The developed desertification risk index can be used for selecting appropriate land management practices and techniques for combating desertification.</p>
              </div>
              <div class="pagination">
                <a href="Apps_LULC_1.php" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('Apps_LULC_1.php', this)" class="page-link ">1</a>
                <a href="#" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('Apps_LULC_2.php', this)" class="page-link active">2</a>
              </div>
            </section>
...
<div id="imgeos-modal" class="modal">
  <div class="modal-content">
    ...
    <h3 class="modal-title">National Wastelands Mapping : 1:50,000 scale</h3>
    <p id="myptag">National wasteland mapping is being done at different time intervals since 1982. Presently, mapping has been completed 5 times since 1982 at NRSC. Waste land mapping was done during 1980-82 (1: 1 million scale- 8 classes), 2000 (1 : 250000 scale – 13 classes), 2003-04 (1:50000 scale-28 classes), 2005-06 (1:50000 scale-28 classes), change mapping during 2008-09, 2015-16.</p>
    <p id="myptag">Wastelands area estimates have served a basis for taking up wastelands reclamation by different states. Spatial maps and database can be utilized to identify the suitable areas for the establishment of various infrastructure projects in the different parts of the country. The database is also being used for watershed prioritization, identification of potential areas for agriculture / afforestation etc. Recent wasteland database is hosted on Bhuvan-Wastelands.</p>
  </div>
</div>
<script>
