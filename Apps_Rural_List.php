...
<a style="background-color:#003366; color: #ffffff;" class="text-white no-hover" >Technical Details</a>
    <a href="./Apps_Rural_Overview.php" >Overview</a>
    <a href="./Apps_Rural_Apps.php" >Applications</a>
    <a href="./Apps_Rural_Sensors.php" >Sensors</a>
    <a href="./Apps_Rural_Users.php" >Users</a>
    <a href="./Apps_Rural_Portals.php" >Portals</a>
</div>
<style>
