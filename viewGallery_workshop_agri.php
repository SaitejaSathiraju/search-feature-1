...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>Workshop on Geospatial Applications in Agriculture at RRSC-South, Bangalore on 31-01-2025</b></h3>
    </div>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const imagePath = 'assets/img/event-gallery/Agriculture_workshop/';
