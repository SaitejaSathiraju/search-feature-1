              ...
              <div class="popup" id="popup">
                ...
                <div class="popup-content">
                  ...
                  <ol id="p-style">
                    ...
                    <li>Creation of digital topographic database 1: 1,000 to 1:2,500 with 1 m contours <p id="popUpText">-53 towns (6200 Sq.Km) - for Town and Country Planning Organisation (TCPO), New Delhi.</p>
                      <p id="popUpText">-6 towns (1400 Sq.Km) -Jaipur, Jodhpur, Ajmer, Kota, Bikaner, Udaipur – for Rajasthan Urban Infrastructure Development Project (RUIDP), Govt. of Rajasthan.</p>
                      <p id="popUpText">-Bangalore city and its surroundings (1400 Sq.Km) –for Bangalore Development Authority (BDA)</p>
                      <p id="popUpText">-Hyderabad city and its surroundings (650 Sq.Km) - for Hyderabad Metropolitan Water Supply and Sewerage Board (HMWS&amp;SB)</p>
                      <p id="popUpText">-31 towns in Tamil Nadu state for Town and Country Planning Department,Tamilnadu</p>
                      <p id="popUpText">-New Bombay, Kalyan and Vasai-Virar areas for BMRDA &amp; CIDCO covering 500 sq. km. Large scale mapping in 1: 500 scale of Kolkata Metropolitan Area covering 200 sq. km for Kolkata Municipal Corporation (KMC).Topographic map preparation from Cartosat -1 stereo data for National Hydro Power Corporation (NHPC)</p>
                    </li>
