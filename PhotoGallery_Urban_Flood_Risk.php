...
<main class="main">
  <div class="container">
    <h3 style="text-align:center">
      <br />
      <b>One-week Capacity Building programme on “Space based Inputs for Reduction and Mitigation of Urban Flood Risk” under ISRO-DMSP during 3-7 Feb, 2025 at RRSC-Nagpur</b>
    </h3>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const imagePath = 'assets/img/event-gallery/Capacity Building/';
