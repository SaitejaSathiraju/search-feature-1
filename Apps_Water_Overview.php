...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Water_List.php'; ?> </aside>
            <section class="col-lg-6">
              <h3>Overview</h3>
              <br />
              <p id="myptag">Remote sensing applications in water resources domain provides key inputs for for planning, monitoring and management of several irrigation projects, estimation of availability of surface water resources and various water balance components and as a science application addresses all the hydrological components of local and regional water cycle. Several projects were executed by NRSC on the performance evaluation of irrigation commands and irrigation potential utilization, assessment of irrigation infrastructure across the country, space inputs for feasibility studies for Inter Linking of rivers, reassessment of water resources at river basin level, reservoir sedimentation, seasonal snow and water bodies information, snow melt runoff etc.</p>
              <br>
              <p id="myptag">The strength of dynamic multi-sensor / satellite based information is providing scope for the development of water resources information systems at state / central level. These information systems are better focused for organization of water resources related database, collection and integration of field data, dissemination to teh stake holders for analysis and preparation of water management plans. Institutionalization is being done for various state / central govt. water resources organisations.</p>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img  data-entity-type=file" src="assets/img/apps/Picture1_34.png" />
                    <div class="image-overlay">National Hydrology Project</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img  data-entity-type=file" src="assets/img/apps/Picture2_20.png" />
                    <div class="image-overlay">Snow Cover Analysis</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img  data-entity-type=file" src="assets/img/apps/Picture1_21.png" />
                    <div class="image-overlay">Information Systems</div>
                  </div>
                </div>
              </div>
            </aside>
