...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Earth_List.php'; ?> </aside>
            <section class="col-lg-6">
              <div class="section">
                <h3>Total Alkalinity and Dissolved Inorganic carbon </h3>
                <p id="myptag">Total alkalinity as the name suggest reflects the ability of seawater to resist acidification in oceanographic perspective. In almost all natural waters alkalinity is produced by dissolved carbon dioxide species, bicarbonates and carbonates. Knowing the total</p>
                <a class="read-more" data-modal="imgeos-modal" id="myptag">Read more</a>
              </div>
              <div class="section">
                <h3>Daily Tropical Cyclone Heat Potential</h3>
                <p id="myptag">Tropical cyclone heat potential (TCHP), is estimated using (a) sea surface height anomaly (SSHA) from the available altimeters, (b) sea surface temperature (SST) from Tropical Rainfall Measuring Mission (TRMM) Microwave Imager (TMI), and (c)</p>
              ...
              <div class="pagination">
                ...
                <a href="#" onclick="loadPage('Apps_Earth_OS_More_2.php', this)" class="page-link active">2</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">3</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">4</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">5</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">6</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">7</a>
                <a href="Apps_Earth_OS_More_3.php" onclick="loadPage('Apps_Earth_OS_More_3.php', this)" class="page-link">8</a>
              </div>
            </section>
            <aside class="col-md-3 sidebar">
              <div class="section">
                <h3>TOTAL ALKALINITY AND <br>DISSOLVED INORGANIC <br> CARBON </h3>
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/apps/img1_10.jpg" data-title="Total Alkalinity">
                    <img alt="antenna1" src="assets/img/apps/img1_10.jpg" />
                    <div class="image-overlay">Total Alkalinity</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/apps/img2_10.jpg" data-title="Dissolved Inorganic Carbon">
                    <img alt="bharati" src="assets/img/apps/img2_10.jpg" />
                    <div class="image-overlay">Dissolved Inorganic Carbon</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/apps/img3_8.jpg" data-title="Ocean Content (700 m)">
                    <img alt="bharati" src="assets/img/apps/img3_8.jpg" />
                    <div class="image-overlay">Ocean Content (700 m)</div>
                  </div>
                </div>
              </div>
            </aside>
...
<div id="imgeos-modal" class="modal">
  <div class="modal-content">
    ...
    <h3 class="modal-title">Total Alkalinity and Dissolved Inorganic carbon </h3>
