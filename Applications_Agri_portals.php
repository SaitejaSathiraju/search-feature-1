...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Applications_Agri_Servicelist.php'; ?> </aside>
            <section class="col-lg-6">
              <h3>Portals</h3>
              <section class="mandate-images ">
                <div class="container-fluid py-4">
                  <div class="row g-3 justify-content-center">
                    <div class="container-fluid py-4">
                      <div class="row g-3 justify-content-center">
                        <div class="col-auto">
                          <a href="https://bhuvan-app1.nrsc.gov.in/tea/rc_bhuvan.php" target="_blank" class="portal-card">
                            <img src="assets/img/about/teaboardlogo.png" class="portal-img" title="Tea Area Management Information System (MIS)">
                          </a>
                        </div>
                        <div class="col-auto">
                          <a href="https://bhuvan-app1.nrsc.gov.in/chaman/" target="_blank" class="portal-card">
                            <img src="assets/img/about/images.jfif" class="portal-img" title="Horticulture Assessment and Management using Geo-informatics (CHAMAN)">
                          </a>
                        </div>
                      </div>
                    </div>
            ...
            <aside class="col-md-3 sidebar">
              <div class="section">
                <h3>AGRICULTURE PORTALS</h3>
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/about/5 fluxtower-sat.png">
                    <img alt="antenna1" src="assets/img/about/5 fluxtower-sat.png" />
                    <div class="image-overlay">Flux Tower</div>
                  </div>
                </div>
              </div>
            </aside>
