...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'App_lulc_services_list.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ol id="myptag">
                <li>
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php" target="_blank">Bhuvan - LULC 250K</a>
                </li>
                <li>
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php" target="_blank">Bhuvan - LULC 50K</a>
                </li>
                <li>
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php" target="_blank">Bhuvan - Wastelands</a>
                </li>
              </ol>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item">
                    <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/lulc/Picture7_6.png">
                      <img src="assets/img/lulc/Picture6_3.png" alt="Landuse / Land Cover - 1:50000" />
                      <div class="image-overlay">Landuse / Land Cover - 1:50000 </div>
                    </div>
                  </div>
                </div>
              </div>
