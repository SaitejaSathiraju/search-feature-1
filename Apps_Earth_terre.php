            ...
            <aside class="col-md-3 sidebar">
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/apps/img1_9.jpg" data-title="View of the parameters utilised for understanding the concept of multi-parameter evaluation to assess risk for estimating the crop insurance products.">
