...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Applications_Agri_Servicelist.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <br />
              <ol id="myptag">
                <li>State and Central Agriculture and Horticulture Departments </li>
                <li>Pradhan Mantri Fasal Bima Yojana (PMFBY)</li>
                <li>Ministry of Commerce</li>
                <li>Ministry of Textiles</li>
                <li>Tea Board of India</li>
                <li>State and Central Disaster authorities</li>
              </ol>
            </section>
            <aside class="col-md-3 sidebar">
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/about/4 rabicrop-India.png">
                    <img alt="antenna1" src="assets/img/about/4 rabicrop-India.png" />
                    <div class="image-overlay">Rabi crop India</div>
                  </div>
                </div>
              </div>
            </aside>
