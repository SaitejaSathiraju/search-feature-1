        ...
        <div class="container-fluid">
          <div class="row gy-4">
            ...
            <section class="col-lg-6">
              <h3>ASI Team Excellence Award, 2009</h3>
              <br />
              <p id="myptag"> For Bhuvan development, Astronautical Society of India (ASI) has awarded Team excellence award to Bhuvan during 2009-2010. </p>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item">
                    <img src="./nrsc_images/about_AandA_2010.jpg" alt="Award Image 1">
                  </div>
                </div>
              </div>
            </aside>
