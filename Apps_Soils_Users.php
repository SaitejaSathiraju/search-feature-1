        ...
        <div class="container-fluid">
          <div class="row gy-4">
            ...
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Ministry of Agriculture and Farmers Welfare (MoA&FW)
                </li>
              </ul>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type=" file" src="assets/img/apps/f water erosion.png" />
                    <div class="image-overlay">Water Erosion Map</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/f-salt lands.png" />
                    <div class="image-overlay">Fractional Map-Salt affected area</div>
                  </div>
                </div>
              </div>
            </aside>
