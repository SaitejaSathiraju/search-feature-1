<div class="services-list">
    <a style="background-color:#003366; color: #ffffff;" class="text-white" >Technical Details</a>
    <a href="./Apps_Forestry_Ecology_Overview.php" >Overview</a>
    <a href="./Apps_Forestry_Ecology_1.php" >Applications</a>
    <a href="./Apps_Forestry_Ecology_sensors.php" >Sensors</a>
    <a href="./Apps_Forestry_Ecology_users.php" >Users</a>
    <a href="./Apps_Forestry_Ecology_portals.php" >Portals</a>
</div>
