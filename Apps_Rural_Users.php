...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Rural_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Ministry of Rural Development
                </li>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>RKVY program of Department of Agriculture, Cooperation & Farmers Welfre
                </li>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>Empowering Panchayati Raj Institutions Spatially (EPRIS)
                </li>
                <br>
              </ul>
            </section>
            <aside class="col-md-3 sidebar">
              <div class="section">
                <h3>RURAL USERS IMAGE</h3>
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/Plantations-monitoring-s.jpg" />
                    <div class="image-overlay">Monitoring Plantations</div>
                  </div>
                </div>
              </div>
            </aside>
