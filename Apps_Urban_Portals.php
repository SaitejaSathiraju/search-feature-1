            ...
            <section class="col-lg-6">
              ...
              <ul>
                <li id="myptag">
                  ...
                  <a href="https://bhuvan-app1.nrsc.gov.in/thematic/thematic/index.php?theme=nuis" target="_blank">Bhuvan-NUIS</a>
                </li>
              </ul>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app1.nrsc.gov.in/urbangrowth/urbangrowth.php" target="_blank">Bhuvan-Urban Sprawl</a>
                </li>
              </ul>
            </section>
              ...
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/nuis-rajkot-sm_0.jpg" />
                    <div class="image-overlay">NUIS</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/ugm  sm.jpg" />
                    <div class="image-overlay">Urban sprawl</div>
                  </div>
                </div>
              </div>
            </aside>
