 ...
 aria-label="Course Navigation"> <?php include 'Applications_Agri_Servicelist.php'; ?> </aside>
            <section class="col-lg-6">
              <div class="section">
                ...
                <p id="myptag">The Pradhan Mantri Fasal BimaYojana (PMFBY) is a national flagship programme for providing crop insurance in the country. NRSC is carrying out geomatics based studies towards improving the area-yield estimates, a key input to the development of methodologies for crop insurance mechanism.</p>
                <a class="read-more" data-modal="imgeos-modal" id="myptag">Read more</a>
              </div>
              <div class="section">
                <h3>Crop Intensification</h3>
                <p id="myptag">India grows 36 Mha of rice crop in kharif season in India. This is important contribution to food production in India as rice is the main food crop. It is observed that about 30% of this area is left fallow after the harvest of rice crop. Mapping and monitoring of post-kharif rice fallow lands using satellite data will help identification of suitable areas for intensification of rabi crop area. </p>
                <a class="read-more" data-modal="ageos-modal" id="myptag">Read more</a>
              </div>
              <div class="pagination">
                <a href="#" onclick="localStorage.setItem('activeMenuItem', 'Applications') ;loadPage('Agr_Apps.php', this)" class="page-link active">1</a>
...
<div id="ageos-modal" class="modal">
  <div class="modal-content">
    ...
    <p id="myptag">Sub district level spatial level information is generated and studied for the assessment of crop intensification in major rice-growing states of India namely Assam, Bihar, Odisha, Chhattisgarh, Jharkhand, West Bengal. The aim of this project is to provide an estimate of spatial extent and distribution of post kharif rice – rabi fallows, and also their suitability for growing short duration pulses.</p>
    <p id="myptag">Mobile applications are deployed for seasonal field data collection for geo-tagging the crop scenario.Information is available on Bhuvan-Crop intensification portal which is useful for decision makers, extension agencies and researchers.</p>
  </div>
</div>
<script>
