...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'about_DPD_Services_List.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <p id="p-style"> As per Indian Space policy 2023, from 01 May 2024, all commercial activities with respect to IRS satellite data and products would be handled by NEWSPACE INDIA LIMITED (NSIL). Bhoonidhi will continue to be the data dissemination platform. </p>
              ...
              <br />
              <br />
              <a href="assets/pdf/GE_NGE_Document_format.docx" style="font-size:20px;" target="_blank">GE Declaration Form </a>
              <img src="assets/img/newlabel.png" width="50px" height="20px">
            </section>
