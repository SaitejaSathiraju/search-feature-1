...
<main id="main-content" class="main" role="main">
 ...
 aria-label="Course Navigation"> <?php include 'Apps_Rural_List.php'; ?> </aside>
            <section class="col-lg-6">
              <h3>Portals</h3>
              <br />
              <p id="myptag">ISRO’s Geo-portal (Bhuvan)</p>
              <ul>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app1.nrsc.gov.in/iwmp/index.php" ; target="_blank" ;>Bhuvan-IWMP
                </li>
                </a>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app1.nrsc.gov.in/nabard/index.php" ; target="_blank" ;>Bhuvan-NABARD
                </li>
                </a>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app2.nrsc.gov.in/mgnrega/mgnrega_phase2.php" ; target="_blank" ;>Bhuvan-MGNREGA
                </li>
                </a>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-app1.nrsc.gov.in/rkvy/" ; target="_blank" ;>Bhuvan-RKVY
                </li>
                </a>
                <br>
                <li id="myptag">
                  <i class="bi bi-check-circle"></i>
                  <a href="https://bhuvan-panchayat3.nrsc.gov.in/" ; target="_blank" ;>Bhuvan Panchayat Portal
                </li>
                </a>
                <br>
              </ul>
            ...
            <aside class="col-md-3 sidebar">
              <div class="section">
                <h3>SOILS PORTALS IMAGE</h3>
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)">
                    <img data-entity-type="file" src="assets/img/apps/Percolation Tank with field photograph-s.jpg" />
