 ...
 aria-label="Course Navigation"> <?php include 'Apps_Forestry_Ecology_servicesList.php'; ?> </aside>
            <section class="col-lg-6">
              ...
              <ol style="text-align:justify; font-size: 20px">
                <li>Orissa and Telangana State forest departments </li>
                <li>National Carbon Project” (NCP) -ISRO – Geosphere Biosphere Program (IGBP)</li>
                <li>UNESCO`s flagship program; “Man and Biosphere (MAB)</li>
              </ol>
            </section>
            <aside class="col-md-3 sidebar">
              <div class="section">
                ...
                <div class="image-gallery">
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/forestry/F-LIDAR  for Forest Biomass-small_0.jpg" data-title="Biomass estimation in Forest">
                    <img src="assets/img/forestry/F-LIDAR  for Forest Biomass-small.jpg" alt="Biomass estimation in Forest" />
                    <div class="image-overlay">Biomass estimation in Forest</div>
                  </div>
                  <div class="image-item" onclick="openLightbox(this)" data-large-src="assets/img/forestry/Flux Tower -instruments-small_0.jpg" data-title="Instruments on flux towers">
                    <img src="assets/img/forestry/Flux Tower -instruments-small.jpg" alt="Instruments on flux towers" />
                    <div class="image-overlay">Instruments on flux towers</div>
                  </div>
                </div>
              </div>
            </aside>
