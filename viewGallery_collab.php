...
<main class="main">
  <div >
    <div class="container">
      <h3 style="text-align:center"><br/><b>"Strengthening Academia-Industry Collaboration" - NRSC, ISRO Signs MoUs with Leading Academic Institutions in the presence of Secretary, DoS & Chairman, ISRO on 5th March, 2025 at RRSC, North</b></h3>
    </div>
  </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const totalImages = 4; // Modify if needed
    const imagePath = 'assets/img/event-gallery/Academia_industryCollab/';
